    ...
    <div className='bg-white p-4 rounded-2xl shadow-md text-gray-500 font-medium mt-6'>
        ...
        <Image 
            ...
            <form action="" className='flex flex-1'>
                <input 
                className='rounded-full h-12 bg-gray-100 flex-grow px-5 outline-none' type="text" 
                name="" 
                id="" 
...
<div onClick={() => filepickerRef.current.click()} className='inputIcon relative cursor-pointer'>
<CameraIcon className='h-7 text-green-400' />
    <p type="file" className='text-xs sm:text-sm xl:text-base'>Photo/Video</p>
    {/* <input 
    ref={filepickerRef}
